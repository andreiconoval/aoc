...
class EdmondsKarpAlgorithm(generic_dmf_algorithm.GenericFlowAlgorithm):
    ...
    def find_augmenting_path(self, residual_network):
        visited_nodes = deque([self.source])
        analyzed_nodes = []
        ...
        while visited_nodes and self.predecessors[self.sink] < 0:
            ...
            print(f"Visited Nodes: {list(visited_nodes)}")
    ...
    def run_edmonds_karp_algorithm(self, flows, capacities):
